package scene {
	 ...
	 * @author ...
	 */
	public class FalseScene extends BaseScene {
		 ...
		 */
		public function FalseScene( name:String = null, initObject:Object = null ) {
			// 親クラスを初期化する
			super( name, initObject );
			
			batsu = new Batsu();
			batsu.x = IndexScene.windowWidth/2;
			batsu.y = IndexScene.windowHeight/2;
			page.addChild( batsu );
		}

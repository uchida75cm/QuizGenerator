package scene {
	 ...
	 * @author ...
	 */
	public class AnswerScene extends BaseScene {
		 ...
		 */
		public function AnswerScene( name:String = null, initObject:Object = null ) {
			// 親クラスを初期化する
			super( name, initObject );
			
			req = new URLRequest( initObject.ans );
			ldr = new Loader();
			ldr.contentLoaderInfo.addEventListener( Event.COMPLETE, loadingAnswer );
			ldr.load( req );
		}
		
		private function loadingAnswer( event: Event ): void {
			page.addChild( ldr );
		}

package scene {
	 ...
	 * @author ...
	 */
	public class TrueScene extends BaseScene {
		 ...
		 */
		public function TrueScene( name:String = null, initObject:Object = null ) {
			// 親クラスを初期化する
			super( name, initObject );
			
			maru = new Maru();
			maru.x = IndexScene.windowWidth/2;
			maru.y = IndexScene.windowHeight/2;
			page.addChild( maru );
		}
